...
#Let's only keep  the two first attributes
X,y = iris.data[:,:2] , iris.target

# we'll use half of the dataset for evaluation
X_train, X_test, y_train, y_test = train_test_split(X,y, test_size = 0.5)

# Trainig the training dataset set to a linaer support vector
...
#Display the decision surace we are gonna discretiser l'espace avec un pas h
